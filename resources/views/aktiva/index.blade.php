            ...
            <div class="col-lg">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="ri-add-box-line mb-3"></i></button>
                        </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center d-flex">
                                        <button type="button" class="btn btn-warning btn-edit d-flex h-75" data-id="{{ $data->id }}" data-nama="{{ $data->nama }}">
                                            Edit <i class="ri-edit-box-line ml-2"></i>
                                        </button>


                                        <form action="{{ route('delete.aktiva', ['id' => $data->id]) }}" method="POST">
                                            @csrf
                                            <button type="submit" class="btn btn-danger ml-2 d-flex">Hapus <i class="ri-delete-bin-2-line ml-2"></i>
                                            </button>
